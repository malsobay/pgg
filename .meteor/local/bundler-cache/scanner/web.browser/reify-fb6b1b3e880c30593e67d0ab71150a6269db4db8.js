module.export({isRefObject:()=>isRefObject,isRefCallback:()=>isRefCallback,setRef:()=>setRef,combineRefs:()=>combineRefs,mergeRefs:()=>mergeRefs,getRef:()=>getRef,refHandler:()=>refHandler});/*
