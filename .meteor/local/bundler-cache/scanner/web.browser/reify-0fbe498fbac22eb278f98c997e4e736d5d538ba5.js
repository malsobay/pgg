module.export({AbstractComponent2:()=>AbstractComponent2});let __extends;module.link("tslib",{__extends(v){__extends=v}},0);let React;module.link("react",{"*"(v){React=v}},1);let isNodeEnv;module.link("./utils",{isNodeEnv(v){isNodeEnv=v}},2);/*
