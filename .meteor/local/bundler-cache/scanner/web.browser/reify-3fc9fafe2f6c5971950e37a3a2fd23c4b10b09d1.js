module.export({SpinnerSize:()=>SpinnerSize,Spinner:()=>Spinner});let __assign,__extends,__rest;module.link("tslib",{__assign(v){__assign=v},__extends(v){__extends=v},__rest(v){__rest=v}},0);let classNames;module.link("classnames",{default(v){classNames=v}},1);let React;module.link("react",{"*"(v){React=v}},2);let AbstractPureComponent2,Classes;module.link("../../common",{AbstractPureComponent2(v){AbstractPureComponent2=v},Classes(v){Classes=v}},3);let SPINNER_WARN_CLASSES_SIZE;module.link("../../common/errors",{SPINNER_WARN_CLASSES_SIZE(v){SPINNER_WARN_CLASSES_SIZE=v}},4);let DISPLAYNAME_PREFIX;module.link("../../common/props",{DISPLAYNAME_PREFIX(v){DISPLAYNAME_PREFIX=v}},5);let clamp;module.link("../../common/utils",{clamp(v){clamp=v}},6);/*
...
})(SpinnerSize || (module.runSetters(SpinnerSize = {})));
