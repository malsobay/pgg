module.export({Portal:()=>Portal});let React;module.link("react",{"*"(v){React=v}},0);let ReactDOM;module.link("react-dom",{"*"(v){ReactDOM=v}},1);let Classes;module.link("../../common/classes",{"*"(v){Classes=v}},2);let Errors;module.link("../../common/errors",{"*"(v){Errors=v}},3);let DISPLAYNAME_PREFIX;module.link("../../common/props",{DISPLAYNAME_PREFIX(v){DISPLAYNAME_PREFIX=v}},4);let PortalContext;module.link("../../context/portal/portalProvider",{PortalContext(v){PortalContext=v}},5);let usePrevious;module.link("../../hooks/usePrevious",{usePrevious(v){usePrevious=v}},6);/*
