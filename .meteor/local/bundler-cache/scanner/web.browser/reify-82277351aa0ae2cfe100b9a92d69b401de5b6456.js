module.export({AbstractButton:()=>AbstractButton});let __extends;module.link("tslib",{__extends(v){__extends=v}},0);let classNames;module.link("classnames",{default(v){classNames=v}},1);let React;module.link("react",{"*"(v){React=v}},2);let AbstractPureComponent2,Classes,Keys,Utils;module.link("../../common",{AbstractPureComponent2(v){AbstractPureComponent2=v},Classes(v){Classes=v},Keys(v){Keys=v},Utils(v){Utils=v}},3);let Icon,IconSize;module.link("../icon/icon",{Icon(v){Icon=v},IconSize(v){IconSize=v}},4);let Spinner;module.link("../spinner/spinner",{Spinner(v){Spinner=v}},5);/*
