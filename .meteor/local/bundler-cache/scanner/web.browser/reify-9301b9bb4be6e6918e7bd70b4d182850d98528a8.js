module.export({isNodeEnv:()=>isNodeEnv,arrayLengthCompare:()=>arrayLengthCompare,approxEqual:()=>approxEqual,clamp:()=>clamp,countDecimalPlaces:()=>countDecimalPlaces,uniqueId:()=>uniqueId});let CLAMP_MIN_MAX;module.link("../errors",{CLAMP_MIN_MAX(v){CLAMP_MIN_MAX=v}},0);/*
