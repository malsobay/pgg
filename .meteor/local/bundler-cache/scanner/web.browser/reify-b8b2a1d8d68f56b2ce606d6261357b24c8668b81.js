module.export({MultiSlider:()=>MultiSlider});let tslib_1;module.link("tslib",{"*"(v){tslib_1=v}},0);let classNames;module.link("classnames",{default(v){classNames=v}},1);let React;module.link("react",{"*"(v){React=v}},2);let Classes,Intent;module.link("../../common",{Classes(v){Classes=v},Intent(v){Intent=v}},3);let AbstractPureComponent;module.link("../../common/abstractPureComponent",{AbstractPureComponent(v){AbstractPureComponent=v}},4);let Errors;module.link("../../common/errors",{"*"(v){Errors=v}},5);let DISPLAYNAME_PREFIX;module.link("../../common/props",{DISPLAYNAME_PREFIX(v){DISPLAYNAME_PREFIX=v}},6);let Utils;module.link("../../common/utils",{"*"(v){Utils=v}},7);let Handle;module.link("./handle",{Handle(v){Handle=v}},8);let HandleInteractionKind,HandleType;module.link("./handleProps",{HandleInteractionKind(v){HandleInteractionKind=v},HandleType(v){HandleType=v}},9);let argMin,fillValues,formatPercentage;module.link("./sliderUtils",{argMin(v){argMin=v},fillValues(v){fillValues=v},formatPercentage(v){formatPercentage=v}},10);/*
...
var MultiSlider = /** @class */ (function (_super) {
    ...
    MultiSlider.Handle = function () { return null; };
    return MultiSlider;
}(AbstractPureComponent));
...
function getSortedHandleProps(_a, predicate) {
    ...
    var maybeHandles = React.Children.map(children, function (child) { return (Utils.isElementOfType(child, MultiSlider.Handle) && predicate(child.props) ? child.props : null); });
