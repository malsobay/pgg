module.export({IconSize:()=>IconSize,Icon:()=>Icon});let __assign,__extends,__rest;module.link("tslib",{__assign(v){__assign=v},__extends(v){__extends=v},__rest(v){__rest=v}},0);let classNames;module.link("classnames",{default(v){classNames=v}},1);let React;module.link("react",{"*"(v){React=v}},2);let iconNameToPathsRecordKey,IconSvgPaths16,IconSvgPaths20;module.link("@blueprintjs/icons",{iconNameToPathsRecordKey(v){iconNameToPathsRecordKey=v},IconSvgPaths16(v){IconSvgPaths16=v},IconSvgPaths20(v){IconSvgPaths20=v}},3);let AbstractPureComponent2,Classes,DISPLAYNAME_PREFIX;module.link("../../common",{AbstractPureComponent2(v){AbstractPureComponent2=v},Classes(v){Classes=v},DISPLAYNAME_PREFIX(v){DISPLAYNAME_PREFIX=v}},4);let uniqueId;module.link("../../common/utils",{uniqueId(v){uniqueId=v}},5);/*
