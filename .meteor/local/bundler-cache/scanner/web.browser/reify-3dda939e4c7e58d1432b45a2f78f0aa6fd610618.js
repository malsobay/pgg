module.export({isHotkeysDialogShowing:()=>isHotkeysDialogShowing,setHotkeysDialogProps:()=>setHotkeysDialogProps,showHotkeysDialog:()=>showHotkeysDialog,hideHotkeysDialog:()=>hideHotkeysDialog,hideHotkeysDialogAfterDelay:()=>hideHotkeysDialogAfterDelay});let tslib_1;module.link("tslib",{"*"(v){tslib_1=v}},0);let classNames;module.link("classnames",{default(v){classNames=v}},1);let React;module.link("react",{"*"(v){React=v}},2);let ReactDOM;module.link("react-dom",{"*"(v){ReactDOM=v}},3);let Classes;module.link("../../common",{Classes(v){Classes=v}},4);let Dialog;module.link("../../components",{Dialog(v){Dialog=v}},5);let Hotkey;module.link("./hotkey",{Hotkey(v){Hotkey=v}},6);let Hotkeys;module.link("./hotkeys",{Hotkeys(v){Hotkeys=v}},7);/*
...
var HotkeysDialog = /** @class */ (function () {
    ...
    HotkeysDialog.prototype.renderComponent = function () {
        return (React.createElement(Dialog, tslib_1.__assign({}, this.componentProps, { className: classNames(Classes.HOTKEY_DIALOG, this.componentProps.className), isOpen: this.isDialogShowing, onClose: this.hide }),
