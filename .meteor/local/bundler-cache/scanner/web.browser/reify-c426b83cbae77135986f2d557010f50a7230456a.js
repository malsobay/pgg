...
var TreeNode = /** @class */ (function (_super) {
    ...
    TreeNode.prototype.maybeRenderCaret = function () {
        ...
        if (hasCaret) {
            ...
            return (React.createElement(Icon, { title: isExpanded ? "Collapse group" : "Expand group", className: caretClasses, onClick: onClick, icon: "chevron-right" }));
        }
