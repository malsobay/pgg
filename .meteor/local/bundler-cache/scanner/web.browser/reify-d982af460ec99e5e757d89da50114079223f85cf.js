module.export({NumericInput:()=>NumericInput});let tslib_1;module.link("tslib",{"*"(v){tslib_1=v}},0);let classNames;module.link("classnames",{default(v){classNames=v}},1);let React;module.link("react",{"*"(v){React=v}},2);let AbstractPureComponent,Classes,DISPLAYNAME_PREFIX,Keys,Position,removeNonHTMLProps,Utils;module.link("../../common",{AbstractPureComponent(v){AbstractPureComponent=v},Classes(v){Classes=v},DISPLAYNAME_PREFIX(v){DISPLAYNAME_PREFIX=v},Keys(v){Keys=v},Position(v){Position=v},removeNonHTMLProps(v){removeNonHTMLProps=v},Utils(v){Utils=v}},3);let Errors;module.link("../../common/errors",{"*"(v){Errors=v}},4);let ButtonGroup;module.link("../button/buttonGroup",{ButtonGroup(v){ButtonGroup=v}},5);let Button;module.link("../button/buttons",{Button(v){Button=v}},6);let InputGroup;module.link("./inputGroup",{InputGroup(v){InputGroup=v}},7);/*
...
var NumericInput = /** @class */ (function (_super) {
    ...
    NumericInput.prototype.render = function () {
        ...
        var inputGroup = (React.createElement(InputGroup, tslib_1.__assign({ autoComplete: "off" }, inputGroupHtmlProps, { intent: this.props.intent, inputRef: this.inputRef, key: "input-group", large: large, leftIcon: this.props.leftIcon, onFocus: this.handleInputFocus, onBlur: this.handleInputBlur, onChange: this.handleInputChange, onKeyDown: this.handleInputKeyDown, onKeyPress: this.handleInputKeyPress, onPaste: this.handleInputPaste, value: this.state.value })));
        ...
        if (buttonPosition === "none" || buttonPosition === null) {
            ...
            var buttonGroup = (React.createElement(ButtonGroup, { className: Classes.FIXED, key: "button-group", vertical: true },
                incrementButton,
                decrementButton));
            var inputElems = buttonPosition === Position.LEFT ? [buttonGroup, inputGroup] : [inputGroup, buttonGroup];
            var classes = classNames(Classes.NUMERIC_INPUT, Classes.CONTROL_GROUP, (_b = {},
    ...
    NumericInput.prototype.renderButton = function (key, iconName, onMouseDown, onKeyDown, onKeyUp) {
        return (React.createElement(Button, { disabled: this.props.disabled || this.props.readOnly, icon: iconName, intent: this.props.intent, key: key, onBlur: this.handleButtonBlur, onMouseDown: onMouseDown, onFocus: this.handleButtonFocus, onKeyDown: onKeyDown, onKeyUp: onKeyUp }));
    };
