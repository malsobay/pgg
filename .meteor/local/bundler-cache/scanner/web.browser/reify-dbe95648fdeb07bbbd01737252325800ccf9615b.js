module.export({Expander:()=>Expander,Tabs:()=>Tabs});let __assign,__extends;module.link("tslib",{__assign(v){__assign=v},__extends(v){__extends=v}},0);let classNames;module.link("classnames",{default(v){classNames=v}},1);let React;module.link("react",{"*"(v){React=v}},2);let AbstractPureComponent2,Classes,Keys;module.link("../../common",{AbstractPureComponent2(v){AbstractPureComponent2=v},Classes(v){Classes=v},Keys(v){Keys=v}},3);let DISPLAYNAME_PREFIX;module.link("../../common/props",{DISPLAYNAME_PREFIX(v){DISPLAYNAME_PREFIX=v}},4);let Utils;module.link("../../common/utils",{"*"(v){Utils=v}},5);let Tab;module.link("./tab",{Tab(v){Tab=v}},6);let generateTabPanelId,generateTabTitleId,TabTitle;module.link("./tabTitle",{generateTabPanelId(v){generateTabPanelId=v},generateTabTitleId(v){generateTabTitleId=v},TabTitle(v){TabTitle=v}},7);/*
...
var Expander = function () { return React.createElement("div", { className: Classes.FLEX_EXPANDER }); };
