module.export({MultiSlider:()=>MultiSlider});let __assign,__extends;module.link("tslib",{__assign(v){__assign=v},__extends(v){__extends=v}},0);let classNames;module.link("classnames",{default(v){classNames=v}},1);let React;module.link("react",{"*"(v){React=v}},2);let AbstractPureComponent2,Classes,Intent;module.link("../../common",{AbstractPureComponent2(v){AbstractPureComponent2=v},Classes(v){Classes=v},Intent(v){Intent=v}},3);let Errors;module.link("../../common/errors",{"*"(v){Errors=v}},4);let DISPLAYNAME_PREFIX;module.link("../../common/props",{DISPLAYNAME_PREFIX(v){DISPLAYNAME_PREFIX=v}},5);let Utils;module.link("../../common/utils",{"*"(v){Utils=v}},6);let Handle;module.link("./handle",{Handle(v){Handle=v}},7);let HandleInteractionKind,HandleType;module.link("./handleProps",{HandleInteractionKind(v){HandleInteractionKind=v},HandleType(v){HandleType=v}},8);let argMin,fillValues,formatPercentage;module.link("./sliderUtils",{argMin(v){argMin=v},fillValues(v){fillValues=v},formatPercentage(v){formatPercentage=v}},9);/*
