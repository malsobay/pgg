...
var Tag = /** @class */ (function (_super) {
    ...
    Tag.prototype.render = function () {
        ...
        var removeButton = isRemovable ? (React.createElement("button", { "aria-label": "Remove Tag", type: "button", className: Classes.TAG_REMOVE, onClick: this.onRemoveClick, tabIndex: interactive ? tabIndex : undefined },
