module.export({PanelStack2:()=>PanelStack2});let __spreadArray;module.link("tslib",{__spreadArray(v){__spreadArray=v}},0);let classNames;module.link("classnames",{default(v){classNames=v}},1);let React;module.link("react",{"*"(v){React=v}},2);let CSSTransition,TransitionGroup;module.link("react-transition-group",{CSSTransition(v){CSSTransition=v},TransitionGroup(v){TransitionGroup=v}},3);let Classes,DISPLAYNAME_PREFIX;module.link("../../common",{Classes(v){Classes=v},DISPLAYNAME_PREFIX(v){DISPLAYNAME_PREFIX=v}},4);let PanelView2;module.link("./panelView2",{PanelView2(v){PanelView2=v}},5);/*
...
var PanelStack2 = function (props) {
    ...
    var stack = React.useMemo(function () { return (propsStack != null ? propsStack.slice().reverse() : localStack); }, [localStack, propsStack]);
    ...
    var handlePanelOpen = React.useCallback(function (panel) {
        ...
        if (props.stack == null) {
            setLocalStack(function (prevStack) { return __spreadArray([panel], prevStack, true); });
        }
    }, [props.onOpen]);
...
PanelStack2.displayName = "".concat(DISPLAYNAME_PREFIX, ".PanelStack2");
