module.export({HotkeyScope:()=>HotkeyScope,HotkeysEvents:()=>HotkeysEvents});let Children;module.link("react",{Children(v){Children=v}},0);let isElementOfType;module.link("../../common/utils",{isElementOfType(v){isElementOfType=v}},1);let Hotkey;module.link("./hotkey",{Hotkey(v){Hotkey=v}},2);let comboMatches,getKeyCombo,parseKeyCombo;module.link("./hotkeyParser",{comboMatches(v){comboMatches=v},getKeyCombo(v){getKeyCombo=v},parseKeyCombo(v){parseKeyCombo=v}},3);let hideHotkeysDialogAfterDelay,isHotkeysDialogShowing,showHotkeysDialog;module.link("./hotkeysDialog",{hideHotkeysDialogAfterDelay(v){hideHotkeysDialogAfterDelay=v},isHotkeysDialogShowing(v){isHotkeysDialogShowing=v},showHotkeysDialog(v){showHotkeysDialog=v}},4);/*
