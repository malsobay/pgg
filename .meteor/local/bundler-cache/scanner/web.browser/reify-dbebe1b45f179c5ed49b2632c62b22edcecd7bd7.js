module.export({PanelStack:()=>PanelStack});let __extends,__spreadArray;module.link("tslib",{__extends(v){__extends=v},__spreadArray(v){__spreadArray=v}},0);let classNames;module.link("classnames",{default(v){classNames=v}},1);let React;module.link("react",{"*"(v){React=v}},2);let CSSTransition,TransitionGroup;module.link("react-transition-group",{CSSTransition(v){CSSTransition=v},TransitionGroup(v){TransitionGroup=v}},3);let AbstractPureComponent2,Classes;module.link("../../common",{AbstractPureComponent2(v){AbstractPureComponent2=v},Classes(v){Classes=v}},4);let Errors;module.link("../../common/errors",{"*"(v){Errors=v}},5);let PanelView;module.link("./panelView",{PanelView(v){PanelView=v}},6);/*
