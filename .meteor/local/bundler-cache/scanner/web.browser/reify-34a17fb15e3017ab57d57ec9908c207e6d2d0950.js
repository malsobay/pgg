module.export({Overlay:()=>Overlay});let tslib_1;module.link("tslib",{"*"(v){tslib_1=v}},0);let classNames;module.link("classnames",{default(v){classNames=v}},1);let React;module.link("react",{"*"(v){React=v}},2);let CSSTransition,TransitionGroup;module.link("react-transition-group",{CSSTransition(v){CSSTransition=v},TransitionGroup(v){TransitionGroup=v}},3);let findDOMNode;module.link("react-dom",{findDOMNode(v){findDOMNode=v}},4);let Classes;module.link("../../common/classes",{"*"(v){Classes=v}},5);let Keys;module.link("../../common/keys",{"*"(v){Keys=v}},6);let DISPLAYNAME_PREFIX;module.link("../../common/props",{DISPLAYNAME_PREFIX(v){DISPLAYNAME_PREFIX=v}},7);let safeInvoke;module.link("../../common/utils",{safeInvoke(v){safeInvoke=v}},8);let Portal;module.link("../portal/portal",{Portal(v){Portal=v}},9);/*
...
var Overlay = /** @class */ (function (_super) {
    ...
    Overlay.prototype.render = function () {
        ...
        if (usePortal) {
            return React.createElement(Portal, null, transitionGroup);
        }
        else {
