module.export({toLocaleString:()=>toLocaleString,clampValue:()=>clampValue,getValueOrEmptyValue:()=>getValueOrEmptyValue,parseStringToStringNumber:()=>parseStringToStringNumber,isValueNumeric:()=>isValueNumeric,isValidNumericKeyboardEvent:()=>isValidNumericKeyboardEvent,toMaxPrecision:()=>toMaxPrecision,sanitizeNumericInput:()=>sanitizeNumericInput});let clamp;module.link("../../common/utils",{clamp(v){clamp=v}},0);/*
