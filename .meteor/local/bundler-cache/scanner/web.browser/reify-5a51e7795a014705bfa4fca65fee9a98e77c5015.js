module.export({OverflowList:()=>OverflowList});let __extends;module.link("tslib",{__extends(v){__extends=v}},0);let classNames;module.link("classnames",{default(v){classNames=v}},1);let React;module.link("react",{"*"(v){React=v}},2);let Boundary;module.link("../../common/boundary",{Boundary(v){Boundary=v}},3);let Classes;module.link("../../common/classes",{"*"(v){Classes=v}},4);let OVERFLOW_LIST_OBSERVE_PARENTS_CHANGED;module.link("../../common/errors",{OVERFLOW_LIST_OBSERVE_PARENTS_CHANGED(v){OVERFLOW_LIST_OBSERVE_PARENTS_CHANGED=v}},5);let DISPLAYNAME_PREFIX;module.link("../../common/props",{DISPLAYNAME_PREFIX(v){DISPLAYNAME_PREFIX=v}},6);let shallowCompareKeys;module.link("../../common/utils",{shallowCompareKeys(v){shallowCompareKeys=v}},7);let ResizeSensor;module.link("../resize-sensor/resizeSensor",{ResizeSensor(v){ResizeSensor=v}},8);/*
