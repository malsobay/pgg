module.export({PanelView2:()=>PanelView2});let __assign;module.link("tslib",{__assign(v){__assign=v}},0);let React;module.link("react",{"*"(v){React=v}},1);let Classes,DISPLAYNAME_PREFIX;module.link("../../common",{Classes(v){Classes=v},DISPLAYNAME_PREFIX(v){DISPLAYNAME_PREFIX=v}},2);let Button;module.link("../button/buttons",{Button(v){Button=v}},3);let Text;module.link("../text/text",{Text(v){Text=v}},4);/*
