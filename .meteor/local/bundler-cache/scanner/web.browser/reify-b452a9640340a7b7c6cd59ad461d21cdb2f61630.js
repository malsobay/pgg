module.export({PopoverInteractionKind:()=>PopoverInteractionKind,Popover:()=>Popover});let tslib_1;module.link("tslib",{"*"(v){tslib_1=v}},0);let classNames;module.link("classnames",{default(v){classNames=v}},1);let React;module.link("react",{"*"(v){React=v}},2);let Manager,Popper,Reference;module.link("react-popper",{Manager(v){Manager=v},Popper(v){Popper=v},Reference(v){Reference=v}},3);let AbstractPureComponent;module.link("../../common/abstractPureComponent",{AbstractPureComponent(v){AbstractPureComponent=v}},4);let Classes;module.link("../../common/classes",{"*"(v){Classes=v}},5);let Errors;module.link("../../common/errors",{"*"(v){Errors=v}},6);let DISPLAYNAME_PREFIX;module.link("../../common/props",{DISPLAYNAME_PREFIX(v){DISPLAYNAME_PREFIX=v}},7);let Utils;module.link("../../common/utils",{"*"(v){Utils=v}},8);let Overlay;module.link("../overlay/overlay",{Overlay(v){Overlay=v}},9);let ResizeSensor;module.link("../resize-sensor/resizeSensor",{ResizeSensor(v){ResizeSensor=v}},10);let Tooltip;module.link("../tooltip/tooltip",{Tooltip(v){Tooltip=v}},11);let PopoverArrow;module.link("./popoverArrow",{PopoverArrow(v){PopoverArrow=v}},12);let positionToPlacement;module.link("./popoverMigrationUtils",{positionToPlacement(v){positionToPlacement=v}},13);let arrowOffsetModifier,getTransformOrigin;module.link("./popperUtils",{arrowOffsetModifier(v){arrowOffsetModifier=v},getTransformOrigin(v){getTransformOrigin=v}},14);/*
