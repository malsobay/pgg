module.export({HotkeysContext:()=>HotkeysContext,HotkeysProvider:()=>HotkeysProvider});let __assign,__spreadArray;module.link("tslib",{__assign(v){__assign=v},__spreadArray(v){__spreadArray=v}},0);let React;module.link("react",{"*"(v){React=v}},1);let shallowCompareKeys;module.link("../../common/utils",{shallowCompareKeys(v){shallowCompareKeys=v}},2);let HotkeysDialog2;module.link("../../components/hotkeys/hotkeysDialog2",{HotkeysDialog2(v){HotkeysDialog2=v}},3);/*
 ...
 */
var HotkeysContext = React.createContext([initialHotkeysState, noOpDispatch]);
...
var HotkeysProvider = function (_a) {
    ...
    var _c = value !== null && value !== void 0 ? value : React.useReducer(hotkeysReducer, __assign(__assign({}, initialHotkeysState), { hasProvider: true })), state = _c[0], dispatch = _c[1];
