module.export({EditableText:()=>EditableText});let tslib_1;module.link("tslib",{"*"(v){tslib_1=v}},0);let classNames;module.link("classnames",{default(v){classNames=v}},1);let React;module.link("react",{"*"(v){React=v}},2);let AbstractPureComponent;module.link("../../common/abstractPureComponent",{AbstractPureComponent(v){AbstractPureComponent=v}},3);let Classes;module.link("../../common/classes",{"*"(v){Classes=v}},4);let Keys;module.link("../../common/keys",{"*"(v){Keys=v}},5);let DISPLAYNAME_PREFIX;module.link("../../common/props",{DISPLAYNAME_PREFIX(v){DISPLAYNAME_PREFIX=v}},6);let clamp,safeInvoke;module.link("../../common/utils",{clamp(v){clamp=v},safeInvoke(v){safeInvoke=v}},7);let Browser;module.link("../../compatibility",{Browser(v){Browser=v}},8);/*
...
var EditableText = /** @class */ (function (_super) {
    ...
    EditableText.prototype.maybeRenderInput = function (value) {
        var _a = this.props, maxLength = _a.maxLength, multiline = _a.multiline, placeholder = _a.placeholder;
