module.export({PopoverInteractionKind:()=>PopoverInteractionKind,Popover:()=>Popover});let __assign,__extends;module.link("tslib",{__assign(v){__assign=v},__extends(v){__extends=v}},0);let classNames;module.link("classnames",{default(v){classNames=v}},1);let React;module.link("react",{"*"(v){React=v}},2);let Manager,Popper,Reference;module.link("react-popper",{Manager(v){Manager=v},Popper(v){Popper=v},Reference(v){Reference=v}},3);let AbstractPureComponent2,Classes,refHandler,setRef;module.link("../../common",{AbstractPureComponent2(v){AbstractPureComponent2=v},Classes(v){Classes=v},refHandler(v){refHandler=v},setRef(v){setRef=v}},4);let Errors;module.link("../../common/errors",{"*"(v){Errors=v}},5);let DISPLAYNAME_PREFIX;module.link("../../common/props",{DISPLAYNAME_PREFIX(v){DISPLAYNAME_PREFIX=v}},6);let Utils;module.link("../../common/utils",{"*"(v){Utils=v}},7);let Overlay;module.link("../overlay/overlay",{Overlay(v){Overlay=v}},8);let ResizeSensor;module.link("../resize-sensor/resizeSensor",{ResizeSensor(v){ResizeSensor=v}},9);let Tooltip;module.link("../tooltip/tooltip",{Tooltip(v){Tooltip=v}},10);let PopoverArrow;module.link("./popoverArrow",{PopoverArrow(v){PopoverArrow=v}},11);let positionToPlacement;module.link("./popoverMigrationUtils",{positionToPlacement(v){positionToPlacement=v}},12);let arrowOffsetModifier,getTransformOrigin;module.link("./popperUtils",{arrowOffsetModifier(v){arrowOffsetModifier=v},getTransformOrigin(v){getTransformOrigin=v}},13);/*
