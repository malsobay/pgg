module.export({isReactNodeEmpty:()=>isReactNodeEmpty,isReactChildrenElementOrElements:()=>isReactChildrenElementOrElements,ensureElement:()=>ensureElement,getDisplayName:()=>getDisplayName,isElementOfType:()=>isElementOfType});let React;module.link("react",{"*"(v){React=v}},0);/*
