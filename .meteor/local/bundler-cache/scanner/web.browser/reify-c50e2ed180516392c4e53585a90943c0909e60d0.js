module.export({TagInput:()=>TagInput});let tslib_1;module.link("tslib",{"*"(v){tslib_1=v}},0);let classNames;module.link("classnames",{default(v){classNames=v}},1);let React;module.link("react",{"*"(v){React=v}},2);let AbstractPureComponent;module.link("../../common/abstractPureComponent",{AbstractPureComponent(v){AbstractPureComponent=v}},3);let Classes;module.link("../../common/classes",{"*"(v){Classes=v}},4);let Keys;module.link("../../common/keys",{"*"(v){Keys=v}},5);let DISPLAYNAME_PREFIX;module.link("../../common/props",{DISPLAYNAME_PREFIX(v){DISPLAYNAME_PREFIX=v}},6);let Utils;module.link("../../common/utils",{"*"(v){Utils=v}},7);let Icon;module.link("../icon/icon",{Icon(v){Icon=v}},8);let Tag;module.link("../tag/tag",{Tag(v){Tag=v}},9);/*
...
var TagInput = /** @class */ (function (_super) {
    ...
    function TagInput() {
        ...
        _this.maybeRenderTag = function (tag, index) {
            ...
            return (React.createElement(Tag, tslib_1.__assign({ active: index === _this.state.activeIndex, "data-tag-index": index, key: tag + "__" + index, large: large, onRemove: _this.props.disabled ? null : _this.handleRemoveTag }, props), tag));
        };
