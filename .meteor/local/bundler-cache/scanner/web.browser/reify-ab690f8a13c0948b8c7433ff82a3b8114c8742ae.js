module.export({TagInput:()=>TagInput});let __assign,__extends,__spreadArray;module.link("tslib",{__assign(v){__assign=v},__extends(v){__extends=v},__spreadArray(v){__spreadArray=v}},0);let classNames;module.link("classnames",{default(v){classNames=v}},1);let React;module.link("react",{"*"(v){React=v}},2);let AbstractPureComponent2,Classes,Keys,refHandler,setRef,Utils;module.link("../../common",{AbstractPureComponent2(v){AbstractPureComponent2=v},Classes(v){Classes=v},Keys(v){Keys=v},refHandler(v){refHandler=v},setRef(v){setRef=v},Utils(v){Utils=v}},3);let DISPLAYNAME_PREFIX;module.link("../../common/props",{DISPLAYNAME_PREFIX(v){DISPLAYNAME_PREFIX=v}},4);let getActiveElement;module.link("../../common/utils",{getActiveElement(v){getActiveElement=v}},5);let Icon,IconSize;module.link("../icon/icon",{Icon(v){Icon=v},IconSize(v){IconSize=v}},6);let Tag;module.link("../tag/tag",{Tag(v){Tag=v}},7);/*
