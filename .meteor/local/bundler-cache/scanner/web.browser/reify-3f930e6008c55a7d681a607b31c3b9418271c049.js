module.export({Overlay:()=>Overlay});let __assign,__extends;module.link("tslib",{__assign(v){__assign=v},__extends(v){__extends=v}},0);let classNames;module.link("classnames",{default(v){classNames=v}},1);let React;module.link("react",{"*"(v){React=v}},2);let findDOMNode;module.link("react-dom",{findDOMNode(v){findDOMNode=v}},3);let CSSTransition,TransitionGroup;module.link("react-transition-group",{CSSTransition(v){CSSTransition=v},TransitionGroup(v){TransitionGroup=v}},4);let AbstractPureComponent2,Classes,Keys;module.link("../../common",{AbstractPureComponent2(v){AbstractPureComponent2=v},Classes(v){Classes=v},Keys(v){Keys=v}},5);let DISPLAYNAME_PREFIX;module.link("../../common/props",{DISPLAYNAME_PREFIX(v){DISPLAYNAME_PREFIX=v}},6);let getActiveElement,isFunction;module.link("../../common/utils",{getActiveElement(v){getActiveElement=v},isFunction(v){isFunction=v}},7);let Portal;module.link("../portal/portal",{Portal(v){Portal=v}},8);/*
