module.export({AbstractPureComponent:()=>AbstractPureComponent});let tslib_1;module.link("tslib",{"*"(v){tslib_1=v}},0);let React;module.link("react",{"*"(v){React=v}},1);let isNodeEnv;module.link("./utils",{isNodeEnv(v){isNodeEnv=v}},2);/*
