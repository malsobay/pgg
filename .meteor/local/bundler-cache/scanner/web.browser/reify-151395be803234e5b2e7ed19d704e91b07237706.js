module.export({Expander:()=>Expander,Tabs:()=>Tabs});let tslib_1;module.link("tslib",{"*"(v){tslib_1=v}},0);let classNames;module.link("classnames",{default(v){classNames=v}},1);let React;module.link("react",{"*"(v){React=v}},2);let AbstractPureComponent;module.link("../../common/abstractPureComponent",{AbstractPureComponent(v){AbstractPureComponent=v}},3);let Classes;module.link("../../common/classes",{"*"(v){Classes=v}},4);let Keys;module.link("../../common/keys",{"*"(v){Keys=v}},5);let DISPLAYNAME_PREFIX;module.link("../../common/props",{DISPLAYNAME_PREFIX(v){DISPLAYNAME_PREFIX=v}},6);let Utils;module.link("../../common/utils",{"*"(v){Utils=v}},7);let Tab;module.link("./tab",{Tab(v){Tab=v}},8);let generateTabPanelId,generateTabTitleId,TabTitle;module.link("./tabTitle",{generateTabPanelId(v){generateTabPanelId=v},generateTabTitleId(v){generateTabTitleId=v},TabTitle(v){TabTitle=v}},9);/*
