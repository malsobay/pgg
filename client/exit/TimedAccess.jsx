...
export default class TimedAccess extends React.Component {
  ...
  componentDidMount() {
    fetch("https://gist.githubusercontent.com/malsobay/15f783684a3b251e8fc7922382460411/raw/pgg_metaparams", {"cache":"no-cache"})
  ...
  render() {
    ...
    return (
      ...
      <div style={{marginLeft:"30%", marginRight:"30%", marginTop:"3em"}}>
        ...
        {/* <p>4. If the game goes on for longer than expected, <strong>do not worry about timing out for the task. All submissions will be accepted.</strong> Please submit the code presented at the end of game, or NOCODE if you miss it.</p><br/> */}
